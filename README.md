...
3. build your test coverage tool with Soot.
...
2. If your problem is not solved, you are recommended to create an `issue` in this repository. 
3. If you don't want your question to be visible to other classmates, you can send an email to TA. 
...
of statements/branches/lines of this program covered by the test suites.

**Note that all inner classes of CUT should be included in the test.**

The CUT program we prepared indeed contains bugs. 
Don't worry if you found any. 
...
#### Grading Scheme:
Each test suit accounts for `3%` if it can be successfully executed.
...
As such, your tool is able to report the statement coverage achieved by a test suite.
...
### Program output:
For each coverage criterion (Task2, Task3, and Bonus Task), your program need to at least output the following:
...
5. Your need to measure all the five submitted test suites.

## Assignment 1 Overall Submission

- Your are required to submit your assignment to CSE [CASS](http://cssystem.cs.ust.hk/UGuides/cass/student.html).
